...
})({"asvK7":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "9d4efcfabf6b1a8b";
"use strict";
...
var roadSegments = [], roadLength = 1500, sidesSegments = [];
var movingCube;
var collideMeshList = [];
var cubes = [];
...
function update() {
    ...
    for(let i = 0; i <= roadSegments.length - 1; i++){
        ...
        if (seg.position.z > movingCube.position.z + 1200) {
            ...
            destoryMesh(seg);
            if (sidesSegments[i - 1] != undefined) sidesSegments.splice(i, 1);
        }
    }
...
},{}]},["asvK7","8xXkV"], "8xXkV", "parcelRequire7f09", {})

//# sourceMappingURL=race-game-threejs-master.bf6b1a8b.js.map
